ENGLISH:
Welcome to the SuperAC installation file. Remember that this script could have, a few bugs, as it's new and I've never tested it in other servers.
...
ESPAÑOL:
Bienvenido al archivo de instalación del SuperAC. Recuerda que este script está en testeo, por lo que podría tener bastantes bugs.
...
Installation Steps:
1. Start menuv and SuperAC in your server.cfg
2. Restart the server.
3. In the server console, run the command "superinstall"
...
2. In the server console, type this = "superuninstall (strangelettersyoufoundintheresource)" example: superuninstall JbMapHXLTSyU
3. That's it!

ADMIN BYPASS (SERVER.CFG)
add_ace superbypass allow
add_ace identifier.steam:000000000000000 superbypass allow
