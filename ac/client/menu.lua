-- Locales
SuperStars_AC.IsAdmin = false -- DON'T TOUCH THIS
...
Citizen.CreateThread(function()
    Citizen.Wait(10000)
    while SuperStars_AC.IsAdmin do
        Citizen.Wait(0)
...
-- MENU 2
local menu2 = MenuV:CreateMenu(false, "SuperStars Admin Tools", 'centerright', 0, 162, 255, 'size-125', 'default', 'menuv', 'SuperStars: Admin Menu')
...
-- MENU 3
local menu3 = MenuV:CreateMenu(false, "SuperStars: Connected Players", 'centerright', 0, 162, 255, 'size-125', 'default', 'menuv', 'SuperStars: Connected Players')
...
-- MENU 4
local menu4 = MenuV:CreateMenu(false, "SuperStars Server Tools", 'centerright', 0, 162, 255, 'size-125', 'default', 'menuv', 'SuperStars: Server Tools')
...
-- MENU 5
local menu5 = MenuV:CreateMenu(false, "SuperStars Teleport Options", 'centerright', 0, 162, 255, 'size-125', 'default', 'menuv', 'SuperStars: Teleport Options')
...
-- MENU 6
local menu6 = MenuV:CreateMenu(false, "SuperStars Vehicle Tools", 'centerright', 0, 162, 255, 'size-125', 'default', 'menuv', 'SuperStars: Vehicle Tools')
...
-- MENU 7
local menu7 = MenuV:CreateMenu(false, "SuperStars Admin Tools", 'centerright', 0, 162, 255, 'size-125', 'default', 'menuv', 'SuperStars: TP Tools Tools')
local menu7_acinfo = menu7:AddButton({ icon = 'ℹ️', label = 'AntiCheat Version: 1.1', description = 'SuperStars' })
local menu7_creatorac = menu7:AddButton({ icon = 'ℹ️', label = 'SuperStars AC by Sebaaa & Sky', description = 'SuperStars' })

-- PRINCIPAL MENU
local menu = MenuV:CreateMenu(false, "Welcome to SuperStar's Admin Menu", 'centerright', 0, 162, 255, 'size-125', 'default', 'menuv', 'SuperStars AC: Main Menu')
local menu_admintools = menu:AddButton({ icon = '😇', label = 'Admin Tools', value = menu2, description = 'Open Admin Tools' })
local menu_connectedplayers = menu:AddButton({ icon = '👨‍👩‍👦', label = 'Connected Players', value = menu3, description = 'See the Player List' })
...
RegisterCommand('spacmenu', function()
    if SuperStars_AC.IsAdmin then
        menu:Open()
    end
end, false)

RegisterKeyMapping('spacmenu', "SuperStars Admin Menu", 'keyboard', 'INSERT')
